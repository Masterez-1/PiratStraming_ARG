export const movies = [
  ...
  {
    id: 2,
    title: "Rapidos y furiosos Reto Tokio drift",
...
export const series = [
  {
    id: 2,
    title: "El encargado",
    description: "Eliseo trabaja como encargado en un importante edificio y, cada vez que los dueños no están, aprovecha para disfrutar de las comodidades de sus apartamentos.",
    thumbnail: "/images/encargado.jpg",
    src: "/videos/serie.mp4",
    category: "Suspenso",
  },
];
...
export const featuredVideo = {
  id: 4,
  title: "Presentación de la aplicación",
  description: "Video destacado.",
  thumbnail: "/images/rustd.jpg",
  src: "/videos/pagina.mp4",
};
